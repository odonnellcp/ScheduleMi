        ...
        <div class="w3-col m3">
          ...
          <div class="w3-card w3-round">
            <div class="w3-white">
              ...
              <button onclick="location.href = 'https://taskingapplication.herokuapp.com/Php/create_new_manager.html.php';"  class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> Create New Manager</button>
              <?php } ?>
        </div>
      </div>
      <br>
